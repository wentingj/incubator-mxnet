...
void MKLQuantizeComputeUnsigned(const nnvm::NodeAttrs& attrs,
                     const OpContext& ctx,
  ...
  //*outputs[1].dptr<float>() = MinAbs(*inputs[1].dptr<float>(), *inputs[2].dptr<float>());
  *outputs[1].dptr<float>() = 0.0;//MinAbs(*inputs[1].dptr<float>(), *inputs[2].dptr<float>());
...
template<typename SrcType, typename DstType>
void MKLQuantizeComputeZeroCenter(const nnvm::NodeAttrs& attrs,
                     const OpContext& ctx,
                     const std::vector<TBlob>& inputs,
                     const std::vector<OpReqType>& req,
                     const std::vector<TBlob>& outputs) {
...
void MKLQuantizeCompute(const nnvm::NodeAttrs& attrs,
  ...
  if (param.out_type == mshadow::kUint8) {
    MKLQuantizeComputeUnsigned<float, uint8_t>(attrs,
                                              ctx,
                                              inputs,
                                              req,
                                              outputs
    ...
    MKLQuantizeComputeZeroCenter<float, int8_t>(attrs,
                                                 ctx,
                                                 inputs,
                                                 req,
                                                 outputs
