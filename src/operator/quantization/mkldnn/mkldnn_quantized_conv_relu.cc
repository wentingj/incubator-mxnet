...
void MKLDNNQuantizedConvolutionReluForward(const nnvm::NodeAttrs& attrs,
  ...
  //std::cout<<"--MKLQuantizeConvRelu: data min/max="<<in_data[num_inputs].data().dptr<float>()[0]<<in_data[num_inputs+1].data().dptr<float>()[0]<<std::endl;
