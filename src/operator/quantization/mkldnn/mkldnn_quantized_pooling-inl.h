 ...
 * \brief
*/
#ifndef MXNET_OPERATOR_NN_QUANTIZATION_MKLDNN_MKLDNN_QUANTIZED_POOLING_INL_H_
#define MXNET_OPERATOR_NN_QUANTIZATION_MKLDNN_MKLDNN_QUANTIZED_POOLING_INL_H_
...
void MKLDNNQuantizedPoolingFwd::_Init(const mxnet::NDArray &input, const mxnet::NDArray &output,
...
GetQuantizedPoolingFwd(const PoolingParam &param,
              bool is_train,
...
static inline MKLDNNQuantizedPoolingFwd &GetQuantizedPoolingFwd(const PoolingParam &param,
                                              bool is_train,
                                              const NDArray &data,
...
void MKLDNNQuantizedPoolingCompute(const OpContext &ctx, const PoolingParam &param,
  ...
  auto fwd = GetQuantizedPoolingFwd(param, ctx.is_train, in_data, out_data);
