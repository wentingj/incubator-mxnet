...
#python imagenet_gen_qsym.py --model=conv_mnist_mkl --calib-mode=none
#python imagenet_gen_qsym.py --model=conv_mnist_mkl --calib-dataset=./data/val_256_q90.rec --num-calib-batches=5 --calib-mode=naive

#python imagenet_gen_qsym.py --model=imagenet1k-resnet-50 --calib-mode=none
#python imagenet_gen_qsym.py --model=imagenet1k-resnet-152 --calib-mode=none
#
#python imagenet_gen_qsym_bp.py --model=imagenet1k-resnet-152 --calib-dataset=./data/val_256_q90.rec --num-calib-batches=5 --calib-mode=naive
...
#
#python imagenet_gen_qsym_bp.py --model=imagenet1k-resnet-152 --calib-dataset=./data/val_256_q90.rec --num-calib-batches=5 --calib-mode=entropy
...
#python imagenet_gen_qsym_vgg.py --model=vgg16 --label-name=prob_label --calib-dataset=./data/val_256_q90.rec --num-calib-batches=5 --calib-mode=entropy
python imagenet_gen_qsym_vgg.py --model=vgg16 --label-name=prob_label --calib-mode=none
