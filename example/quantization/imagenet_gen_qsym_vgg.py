...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, required=True,
                        help='currently only supports imagenet1k-resnet-152/101/50 or imagenet1k-inception-bn')
    ...
    if args.model == 'imagenet1k-resnet-152':
    ...
    elif args.model == 'imagenet1k-resnet-101':
        rgb_mean = '0,0,0'
        calib_layer = lambda name: name.endswith('_output') and (name.find('conv') != -1
                                                                     or name.find('sc') != -1
                                                                     or name.find('fc') != -1)
        if exclude_first_conv:
            excluded_sym_names = ['conv0']
    elif args.model == 'imagenet1k-resnet-50':
        rgb_mean = '0,0,0'
        calib_layer = lambda name: name.endswith('_output') and (name.find('conv') != -1
                                                                     or name.find('sc') != -1
                                                                     or name.find('fc') != -1)
        ...
        if exclude_first_conv:
            ...
            #excluded_sym_names = ['convRelu1_1']
